# Enhanced //e: cc65's apple2enh target. Everything a ProDOS disk needs is the
# same as apple2's, so this is a copy of apple2.mk rather than an include of
# it -- common.mk derives PLATFORM from the *file* that included it, so
# `include apple2.mk` would build this as PLATFORM=apple2 and put the result in
# the wrong directory with the wrong cl65 target.

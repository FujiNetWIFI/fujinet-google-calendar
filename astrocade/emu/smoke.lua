...
--
-- Launch, then walk the three views (1 day, 2 month, 3 agenda) and open a
-- compose form (5). Snapshots after each. Frames, not attotime seconds.
--
-- Keypad->ioport: KEYn maps to :KEYPADn, bit value 1<<bit (KPTAB order).
--   '1'=KEYPAD3 0x10  '2'=KEYPAD2 0x10  '3'=KEYPAD1 0x10
--   '5'=KEYPAD2 0x08  'C'=KEYPAD3 0x01
--
...
shot(14.0, "day live")
press(16.0, "KEYPAD1", 0x10)    -- '3': agenda
shot(24.0, "agenda live")
press(26.0, "KEYPAD2", 0x10)    -- '2': month
shot(34.0, "month live")
press(36.0, "KEYPAD2", 0x08)    -- '5': compose (blank form)
shot(38.0, "compose form")
press(40.0, "KEYPAD3", 0x01)    -- 'C': leave the form (nothing dirty)
shot(42.0, "back to month")
